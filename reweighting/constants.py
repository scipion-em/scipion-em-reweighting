...
CRYOLIKE_DEFAULT_VER_NUM = V0_0_1
...
CRYOLIKE_DEFAULT_ENV_NAME = getCryoLikeEnvName(CRYOLIKE_DEFAULT_VER_NUM)
CRYOLIKE_DEFAULT_ACTIVATION_CMD = 'conda activate ' + CRYOLIKE_DEFAULT_ENV_NAME
CRYOLIKE_ENV_ACTIVATION = 'CRYOLIKE_ENV_ACTIVATION'
